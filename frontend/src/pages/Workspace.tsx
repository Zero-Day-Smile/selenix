      ...
      <div className="relative min-h-screen text-black dark:text-gray-100 font-sans flex flex-col transition-colors">
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <main className="flex-1 w-full max-w-6xl mx-auto px-6 py-12">
            {restorableRun && (
              <div className="mb-6 bg-blue-50/60 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-500/30 rounded-lg px-5 py-4 flex flex-wrap items-center justify-between gap-4 shadow-sm backdrop-blur-md">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white text-sm font-semibold rounded-md shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-[#0a0b0f]"
                  >
                    Restore Run
                  </button>
                </div>
